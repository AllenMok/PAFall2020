...
plot.py:
Class implement plotting function, plot the the data into line chart. The output plots will be store in '/plot_output'.
...
Brief Description of the Folder
/src:
